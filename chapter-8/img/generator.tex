...
\tikzset{
  pics/feature/.style  args={#1/#2/#3/#4/#5/#6}{% #1=depth, #2=height, #3=width
    code = {
...
\begin{tikzpicture}
  ...
  \pic (feature1) at (3, 0) {feature=0.25/5/5/1/28/28};
  \pic (feature2) at (6, 0) {feature={1.25/4/4/64/14/14}};
  \pic (feature3) at (9.25, 0) {feature={2/2/2/64/7/7}};
  \pic (feature4) at (13.25, 0) {feature={4/0.75/0.75/128/3/3}};
